...
//      Showing my instructor that I can use LLIndexList<> collection with multiple type of linked list data structures
		
//		listTester("Testing as a student the singly linked list with first and last references (SLFLList): ",
//				new LLIndexList<Integer>(new SLFLList<Integer>()));
		
		listTester("Testing as a student the double linked list with header and trailer dummy (DLDHDFTList): ", 
